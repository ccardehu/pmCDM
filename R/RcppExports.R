...
fy_gapmCDM_IS <- function(Y, A, C, mu, R, pM, pR, control) {
    .Call(`_pmCDM_fy_gapmCDM_IS`, Y, A, C, mu, R, pM, pR, control)
}
...
fy_aCDM_IS <- function(Y, G, Qmatrix, Apat, mu, R, pM, pR, control) {
    .Call(`_pmCDM_fy_aCDM_IS`, Y, G, Qmatrix, Apat, mu, R, pM, pR, control)
}
